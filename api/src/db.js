...
const modelActivity =require ('./models/Tourist_activity.js')
const {
...
//console.log(typeof(Country),typeof(Tourist_activity))
...
//.catch((error) => console.log(typeof(Country),typeof(tourist_activity)))
